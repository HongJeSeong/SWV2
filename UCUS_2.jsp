		...
		<%@ page import = "java.sql.*" %>
                ...
                <%@ page import = "java.util.ArrayList" %>
                        ...
                        try{
                                ...
                                String sql1 = "DELETE FROM artifacts_info WHERE project_id="+proj_name+" and artifact_name like 'UC%';";
                                String sql2 = "DELETE FROM artifacts_info WHERE project_id="+proj_name+" and artifact_name like 'US%';";
                                String sql3 = "SELECT a.project_id, b.customized_id, b.value FROM issues AS a, custom_values AS b WHERE a.project_id="+proj_name+" and a.id=b.customized_id and b.value LIKE 'UC%';";
                                String sql4 = "SELECT a.project_id, b.customized_id, b.value FROM issues AS a, custom_values AS b WHERE a.project_id="+proj_name+" and a.id=b.customized_id and b.value LIKE 'US%';";
                        ...
                        for(int i=0; i<=value_count;i++){
                                ...
                                for(int j=0;j<=value_count2; j++){
                                        if(i==0&&j==0){
                                                ...
                                                pstmtTrace = connTrace.prepareStatement("SELECT artifact_id FROM artifacts_info WHERE artifact_name ='"+name_us.get(j-1)+"' and project_id="+proj_name+";");
                                                rs = pstmtTrace.executeQuery();
                                                while(rs.next()){
